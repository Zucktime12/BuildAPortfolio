...
import sequoia from '$lib/assets/projects/sequoia.png';
import fsr from '$lib/assets/projects/fsr.png';
...
const myProjects: Record<string, ProjectDetails> = {
  project1: {
    ...
    name: 'Sequoia',
    image: sequoia,
    desc: 'This was a flagship project for Sequoia. I spearheaded the rework of their website using WordPress and Divi, tailored to meet complex client requirements. My role encompassed building custom pages, integrating dynamic forms, and developing reusable components to enhance functionality and user experience. I managed ongoing client updates, including content refreshes, performance optimizations, and SEO enhancements, ensuring the site remains responsive and aligned with modern web standards. This project showcased my ability to handle large-scale development, coordinate team workflows, and deliver a polished, client-focused solution. When I first joined the team, they used neither Git or any sort of development flow which I immediately implemented. I also fascilitated a move to dedicated hosting, which was a client ask as well as a recommendation from myself due to the past performance of the site. The company also had VERY high security standards as data breaches are detrimental to the company, which was also a big step up with dedicated hosting.',
    havLink: true,
    link: 'https://sequoia.com',
    tag: 'Wordpress',
  ...
  project2: {
    ...
    image: fsr,
    desc: 'I have worked for a few clients as a Freelance contractor. One was a company who was teaching visually impaired students that they can have a career in web development. I was brought on as a Subject Matter Expert for their WooCommerce Store. I worked closely with the instructor for this course and helped with everything from answering questions to API integrations for the WooCommerce Store. I also helped fix a handful of bugs that were created by a previous developer. These fixes were documented so they would be able to be addressed properly in the future. I also worked with a client on their shopify store (gofsr). They had me also work with some API integrations, as well as many customizations that were requested by the client. These customizations ranged from simple CSS updates to new custom components. I also addressed ongoing maintenance for the client and documented everything thoroughly so future updates were run smoothly.',
    havLink: true,
    link: 'https://gofsr.com',
